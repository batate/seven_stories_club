...
defmodule SevenStoriesClubWeb.Coherence.UserEmail do
  @moduledoc false
  use Phoenix.Swoosh, view: SevenStoriesClubWeb.Coherence.EmailView, layout: {SevenStoriesClubWeb.Coherence.LayoutView, :email}
  alias Swoosh.Email
  require Logger
